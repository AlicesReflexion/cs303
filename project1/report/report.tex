...
\begin{section}{Implementation}
  We really only need to keep track of four things:
    ...
    \end{itemize}
    I prefer the 2nd method. It is (subjectively) easier to visualize, and also means there is no need to traverse the entire array of users if we want to figure out who is above/below the elevator. Below is a visualization, followed by a UML diagram:\\
